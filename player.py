...
class Player(sprite.Sprite): ##перемещение метки игрока
    def __init__(self, x, y):
        ...
        self.onGround = False # На земле ли я (по умолчанию)
...
#        Анимация движения влево        
    ...
    def update(self, left, right, up, platforms): ##действия по кнопкам
        ...
        self.onGround = False; # не на земле
    ...
    def collide(self, xvel, yvel, platforms): ##проверка на препятствие
        for p in platforms:
